...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        // TODO dont forger to add boolean for stop server and stop client to check if network manager needs to get out of DDOL
        public void StopServer()
        {
            ...
            {
                Debug.Log("Moved Netrowk Manager From DDOL - server");
        ...
        public void StopClient()
        {
            ...
            if (gameObject != null
                ...
                && SceneManager.GetActiveScene().path != offlineScene)
            {
                Debug.Log("Moved Netrowk Manager From DDOL - client");
                // SceneManager.MoveGameObjectToScene(gameObject, SceneManager.GetActiveScene());
            }
